    ...
    return (
        <Layout className={styles.main} showFooter={false}>
                ...
                <div className={styles.content__main}>
                    ...
                    <div className={styles.main__description}>
                        <div>
                            ...
                            доступность брендовых вещей ~ кроссовок & футболок.{" "}
                            <br />
                            Мы решаем эту проблему! <br />
                            <br />
                            <b>-----</b> <br />
                            <b>VARIO XXY</b> <br />
                            <br />
                            Вам будет представлен большой выбор ассортимента,
                            который <br />
                            поможет вам подобрать крутой look и заказать его без
                            долгого ожидания. <br />
                        </div>
                    </div>
                </div>
            ...
            <div className={styles.main__background}>
                <svg
                    className={styles.main__background__image}
                    viewBox="0 0 752 846"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                >
                    <ellipse
                        ...
                        rx="221.615"
                        ry="223.802"
                        transform="rotate(136.94 467.913 315.277)"
                        fill="url(#paint0_radial_5_5871)"
                        fillOpacity="0.23"
                    />
                    <ellipse
                        cx="469.666"
                        ...
                        rx="300.346"
                        ry="302.533"
                        transform="rotate(136.94 469.666 507.204)"
                        fill="url(#paint1_radial_5_5871)"
                        fillOpacity="0.23"
                    />
                    <defs>
                        <radialGradient
                            id="paint0_radial_5_5871"
                            cx="0"
                            cy="0"
                            r="1"
