...
const Footer = () => {
    return (
            ...
            <Wrapper className={styles.main__content}>
                <div className={styles.left}>
                    <span className={styles.logo}>
                        var<span className={styles.logo__end}>io</span>
                    </span>
                    <span className={styles.email}>varioshop@yandex.ru</span>
                ...
                <div className={styles.right}>
                    <div className={styles.social}>
                        <div className={styles.social__item}>
                            <a
                                href={"https://instagram.com/vario_shop_kazan"}
                                target="_blank"
                                rel="noreferrer"
                            >
                                <svg
		...
		C98.185,8.018,89.442,11.418,89.442,11.418z"
                        ...
                        <div className={styles.social__item} id={styles.email}>
                            <a
                                href={"mailto:varioshop@yandex.ru"}
                                target="_blank"
                                rel="noreferrer"
                            >
                                <svg
                    ...
                    <div className={styles.subtitle}>
                        ~ эксклюзивные предложения и превью новостей бренда
                    </div>
                    <div className={styles.subscribe}>
                        <input
                            ...
                            disabled
                        />
                        <button disabled className={styles.subscribe__button}>
                            подписаться
                        </button>
                    </div>
                    <span className={styles.email}>varioshop@yandex.ru</span>
